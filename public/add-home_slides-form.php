...
if (isset($_POST['btnAdd'])) {
    ...
    if ($_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
        ...
        $sql = "INSERT INTO home_slides (name, image,link) VALUES ('$name', '$upload_image','$link')";
        $db->sql($sql);
    } else {
        // Image is not uploaded or empty, insert only the name
        $sql = "INSERT INTO home_slides (name,link) VALUES ('$name','$link')";
        $db->sql($sql);
    }
    ...
    if ($result == 1) {
        $error['add_slide'] = "<section class='content-header'>
                                            <span class='label label-success'>Home slide Added Successfully</span> </section>";
    } else {
...
<section class="content-header">
    <h1>Add Home Slide <small><a href='home_slides.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Home Slide</a></small></h1>
